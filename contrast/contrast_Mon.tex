...
\begin{question} Consider the first four measures of \textit{Twinkle Twinkle, Little Star} again:
...
\begin{enumerate}
    \item What's the difference in cents between each pair of consecutive notes? 
...
\end{music}
 ...
 \item Encode Mac's arrangement on the online sequencer. Compare it with the encoding of the original piece you made in a previous task.
...
\begin{enumerate}
\item Consider the cents differences that you calculated on question 1a above and write the sequence of notes that maintains those differences but starting with $A_4$. For example,
